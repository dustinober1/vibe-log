...
must_haves:
  ...
  artifacts:
    - path: "src/transports/file-transport.test.ts"
      ...
      contains: "retention cleanup tests"
    - path: "README.md"
...
<objective>
Add comprehensive tests for retention cleanup and document the feature in README.md with configuration examples and migration guide.

Purpose: Verify retention cleanup works correctly (AND logic, edge cases) and provide user-facing documentation for adoption.
Output: Test suite for retention cleanup and README.md documentation.
</objective>
...
<task type="auto">
  <name>Task 4: Add retention documentation to README.md</name>
...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <how-to-verify>
    ...
    6. Verify all retention tests pass
  </how-to-verify>
  <resume-signal>Type "approved" or describe issues to address</resume-signal>
</task>

<task type="auto">
  <name>Task 5: Add migration guide for retention cleanup</name>
  <files>README.md</files>
  <action>
...
<verification>
- All retention cleanup tests pass
- Tests cover validation, AND logic, edge cases, and integration
...
Tests verify AND logic and edge cases
