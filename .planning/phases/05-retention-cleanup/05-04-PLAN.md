...
must_haves:
  truths:
    ...
    - "Cleanup scheduled 20ms after compression (10ms compression + 10ms buffer)"
  artifacts:
...
<task type="auto">
  ...
  <done>
    ...
    20ms delay (10ms compression + 10ms buffer)
...
- 20ms delay after compression scheduling (10ms + 10ms buffer)
