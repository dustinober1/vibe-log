...
must_haves:
  truths:
    ...
    - "Common production errors documented with solutions"
    - "Diagnostic steps provided for each error type"
    - "ENOSPC, EACCES, ENOENT errors covered"
    - "Multi-process limitation documented"
  artifacts:
...
<task type="auto">
  <name>Create TROUBLESHOOTING.md with common production errors</name>
  ...
  <verify>
    test -f docs/TROUBLESHOOTING.md && grep -l "ENOSPC\|EACCES\|Multi-Process" docs/TROUBLESHOOTING.md
  </verify>
  <done>
    TROUBLESHOOTING.md created with comprehensive error documentation
  </done>
</task>
