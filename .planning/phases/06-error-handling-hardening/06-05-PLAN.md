...
must_haves:
  truths:
    ...
    - "Health monitoring patterns documented"
    - "Error event handling examples provided"
    - "Log file health checks documented"
    - "Rotation status monitoring covered"
    - "Disk usage monitoring included"
  artifacts:
...
<task type="auto">
  <name>Create MONITORING.md with production monitoring guide</name>
  <files>docs/MONITORING.md</files>
  <action>
    Create comprehensive monitoring guide with the following structure:
  ...
  <verify>
    test -f docs/MONITORING.md && grep -l "Health Checks\|Error Event\|Alerting\|Metrics" docs/MONITORING.md
  </verify>
  <done>
    MONITORING.md created with comprehensive monitoring guide
  </done>
</task>
